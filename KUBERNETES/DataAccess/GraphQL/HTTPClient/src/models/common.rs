...
/// Grouped response for owner-based resource queries.
/// Each list contains resources of that DCAT3 type owned by the queried user.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct OwnerResources {
    pub owner: String,
    pub catalogs: Vec<Resource>,
    pub datasets: Vec<Resource>,
    pub dataset_series: Vec<Resource>,
    pub dataservices: Vec<Resource>,
    pub distributions: Vec<Resource>,
    pub total: usize,
}
